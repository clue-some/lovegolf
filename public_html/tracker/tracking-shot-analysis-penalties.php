...
$ogt->assign('products', get_products_by_category(81));

$ogt->assign('pagetitle', 'Penatlies - Shot Analysis - Tracking Centre - Love Golf');

$ogt->display('tracking-shot-analysis-penalties.tpl');
